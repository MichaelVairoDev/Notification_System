...
<div x-data="{ show: true }"
    ...
    class="rounded-md p-4 border {{ $classes }} my-4">
    <div class="flex">
        ...
        @if($dismissible)
            <div class="ml-auto pl-3">
                <div class="-mx-1.5 -my-1.5">
                    <button @click="show = false" type="button" class="inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2" :class="{
